...
public class StageData {
	...
	private StageData(float scrWidth, float scrHeight) {
		...
		stp9.add(0, 1);
		stp9.add((float)0, (float)0.4020);
		stp9.add((float)0.2872, (float)0.2866);
		stp9.add((float)0.7020, (float)0.70);
		stp9.add((float)0.5757, (float)0.1);
				
		StagePolygon stp9_ = new StagePolygon();
		stp9_.add((float)-0.03, (float)1.03);
		stp9_.add((float)-0.03, (float)0.3720);
		stp9_.add((float)0.3172, (float)0.2566);
		stp9_.add((float)0.7320, (float)0.7);
		stp9_.add((float)0.6057, (float)1.03);
				
		Stage st9 = new Stage(3, stp9, stp9_);
		st9.titleImage = R.drawable.s_name8;
		st9.titleClearImage = R.drawable.s_name8_clear;
		st9.score = 0;
		st9.locked = true;
