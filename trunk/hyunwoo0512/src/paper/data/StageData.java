...
public class StageData {
	...
	private StageData() {
		...
		StagePolygon stp11 = new StagePolygon();
		stp11.add(0, 0);
		stp11.add((float)0.54, (float)0.223);
		stp11.add((float)0.8, (float)0.218);
		stp11.add((float)0.86, (float)0.357);
		stp11.add((float)0.356, (float)0.866);
		stp11.add((float)0.223, (float)0.813);
		stp11.add((float)0.223, (float)0.532);
