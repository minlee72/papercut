...
//						Toast.LENGTH_SHORT).show();
				...
				Toast.makeText(this.getContext(), "clickPoint= "+(event.getX()-paper.getLeftTop().x)/paper.getWidth()+
						", "+(event.getY()-paper.getLeftTop().y)/paper.getHeight() , Toast.LENGTH_SHORT).show();
			}
			click = false;
			return true;
		}
