...
public class StageData {
	...
	private StageData() {
		...
		stp6_.add((float)0.22,(float)0.22);
		stp6_.add((float)0.53,(float)-0.03);
		stp6_.add((float)1.03,(float)0.53 );
		stp6_.add((float)0.72,(float)0.78);
		...
		stp7_.add((float)0, (float)0.1623);
		stp7_.add((float)0.27, (float)0.1623);
		stp7_.add((float)0.47, (float)0);
		stp7_.add((float)0.73, (float)0.1623);
		stp7_.add((float)1.03, (float)0.1623);
